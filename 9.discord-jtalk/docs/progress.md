...
| requirements.txt 作成 | 進行中 | 2026-09-13 | discord.py==2.7.1(開発機の実インストール版) / pytest==9.1.1 / pytest-asyncio==1.4.0 / pytest-mock==3.15.1 を固定。README.md に `pip install -r requirements.txt` の手順を追記。コミット待ち |
